...
questions_list.append(
        Question('Какой вид спорта я люблю больше всего?', 'Волейбол', 'Футбол', 'Баскетбол', 'Хоккей'))
questions_list.append(
        Question('В какой соцсети  провожу больше всего времени?', 'Telegram', 'VK', 'WhatsApp', 'TikTok'))
questions_list.append(
        Question('Какую последнюю к/р я написал на 5?', 'Технология', 'Физкультура', 'Русский язык', 'Математика'))
questions_list.append(
        Question('Что  делаю в телефоне больше всего?', 'Переписываюсь', 'Играю', 'Смотю видео', 'Я не сиже в телефоне'))
questions_list.append(
        Question('Что я делаю на переменах?', 'Гуляю по школе', 'Играю', 'Хожу домой', 'Повторяю параграфф'))
questions_list.append(
        Question('Сколько мне лет?', '13', '14', '12', '25'))
app = QApplication([])
